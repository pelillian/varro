...
def main():
    ...
    for idx, aperm in enumerate(product(*[*HYPERPARAM_DICT.values()])):
        ...
        os.system('python -m varro.algo.experiment --ckpt_freq=1000 --purpose=fit --mutpb 1.0 --cxpb 0.0 --model_type=\'{}\' --imutpb={} --ngen={} --popsize={} --strategy=\'{}\' --problem_type=\'{}\' --imutpb_decay={} --novelty_metric=\'{}\' --lambda_penalty=\'{}\' --halloffamesize=0.2'.format(aperm[0], aperm[1], aperm[2], aperm[3], aperm[4], aperm[5], aperm[6], 'hamming' if aperm[4] == 'nsr-es' else None, aperm[7]))
